...
module fan_ctrl #(
    ...
    // 降到 8% 的安全网：温度一过 35°C 就回到 25%，不必指望 8% 去救场。
    parameter [15:0] T0_UP  = 16'd40243,  // 35°C
    parameter [15:0] T0_DN  = 16'd39592,  // 30°C
    ...
    //
    //   档 0  <35°C   8%   安静档（实测自启动下限 6%，见文件头）
    //   档 1  35~45   25%  原来的最低档，现在成了 8% 的安全网
    //   档 2  45~55   40%
    //   档 3  55~65   60%
    //   档 4  65~75   80%
    //   档 5  >75     100%
    //
    // 【顺带修好一件事】原来最低档一路管到 45°C，而这块板**满载都到不了
    // 45°C**（实测风扇全停也只到 36.5°C）—— 也就是说风扇**从来没升过档**，
    // "温度升就提速"这条在这块板上一次都没被真正执行过。加了 35°C 这一档
    // 之后，加负载就能看到它从 8% 升到 25%，这条控制律第一次变得可观测。

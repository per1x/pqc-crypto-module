...
//
// 按 H = 0.5 bit/样本 的保守假设，一轮进来 1088 × 0.5 = 544 bit 熵，挤出
// 256 bit。544 > 256，输出可按满熵计。这笔账的前提是 H ≥ 0.235；这块板上
// SP 800-90B 实测 H = 0.871 bit/样本（board/logs/），余量充足。换一颗器件要
// 重测：真低于 0.235 就把 ABSORB_BLOCKS 调大，每挤出一次前多吸收几个 rate
// 块。参数留在这里就是为此。
//
// 【海绵状态从不重置】

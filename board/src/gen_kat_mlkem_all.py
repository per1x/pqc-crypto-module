...
"""从 NIST ACVP 向量生成三套 ML-KEM 参数集的板上 KAT 头文件
    ...
    python3 board/src/gen_kat_mlkem_all.py > board/src/kat_mlkem_all.h

为什么另起一个头文件、而不是把现有的 board/src/kat_vectors.h 扩开：
...
def main():
    w = sys.stdout.write
    w("// 自动生成，请勿手改 —— board/src/gen_kat_mlkem_all.py\n")

...
|---|---|---|---|
| Keccak + 总线（交付配置） | 18307 | 34.4% | 放得下，余量充足 |
| Keccak + NTT + 总线 | 58350 | 109.7% | **放不下** |
...
|---|---|---|---|---|---|
| pqc_accel_zynq（交付配置） | 18307 | 6071 | 0 | 0 | 844 |
| pqc_accel_zynq（含 NTT） | 58350 | 10271 | 13 | 0 | 23184 |
...
参数会透传到 `pqc_accel_axi` 的 `INCLUDE_NTT`。在 XC7Z020 上这样做会超出容量，
换更大的器件（例如 XC7Z035/XC7Z045）时才有意义。

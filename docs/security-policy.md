...
are listed in [algorithms.md](algorithms.md).
...
[register-map.md](register-map.md). Only the software path is exercised on the
...
in [algorithms.md](algorithms.md#key-and-parameter-inventory).
